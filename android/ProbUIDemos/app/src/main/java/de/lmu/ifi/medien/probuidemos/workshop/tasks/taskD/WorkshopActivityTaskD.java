...
public class WorkshopActivityTaskD extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_workshop_activity_task_d);

        ((MySwatchContainer)findViewById(R.id.probUIContainer)).initSwatches();
