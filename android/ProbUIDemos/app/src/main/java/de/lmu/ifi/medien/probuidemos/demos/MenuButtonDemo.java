...
import de.lmu.ifi.medien.probuidemos.gui.elements.ProbMenuButton;

public class MenuButtonDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_button_demo);

        ProbMenuButton menuButton = (ProbMenuButton) findViewById(R.id.menu_button);
        menuButton.initMenu();
    ...
    public void onClickOne(View view) {
        Log.d("Prob Debug", "Menu button clicked!");
